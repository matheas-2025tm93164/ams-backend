...
from app.application.auth_service import AuthService, hash_password
...
async def seed_demo_users(repo: UserRepository) -> None:
    ...
    demos = [
        (
            os.getenv("SEED_ADMIN_EMAIL", "admin@apartment.local"),
            os.getenv("SEED_ADMIN_PASSWORD", "Admin123!pass"),
            os.getenv("SEED_ADMIN_NAME", "Building Admin"),
            Role.ADMIN,
        ),
        (
            os.getenv("SEED_STAFF_EMAIL", "staff@apartment.local"),
